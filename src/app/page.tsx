...
export default function Home() {
  return (
    <div className="bg-slate-50">
      <section>
        <MaxWidthWrapper className="pb-24 pt-1 lg:grid lg:grid-cols-3 sm:pb-32 lg:gap-x-0 xl:gap-x-8 lg-pt-24 xl:pt-32 lg-pb-52">
      ...
      <section className="bg-slate-100 py-24">
        <MaxWidthWrapper className="flex flex-col gap-16 items-center sm:gap-32">
              ...
              <div className="flex gap-4 mt-2">
                ...
                <div className="flex flex-col ">
                  ...
                  <div className="flex gap-1.5 items-center text-zinc-600">
                    <Check className="w-4 h-4 stroke-[3px] text-purple-600" />
        ...
        <MaxWidthWrapper className="py-24">
          ...
          <div className="mx-auto max-w-6xl px-6 lg:px-8">
            <div className="relative flex flex-col items-center md:grid grid-cols-2 gap-40">
              <img
                src="/arrow.png"
                className="absolute top-[24rem] md:top-1/2 -translate-y-1/2 z-10 left-1/2 -translate-x-1/2 rotate-90 md:rotate-0"
              />
